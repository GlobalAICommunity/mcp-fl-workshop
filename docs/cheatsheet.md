...
then returns parsed calls for `qwen3.5-9b`; the host handles `final_answer`
...
The event image uses the cached CPU variant of `qwen3.5-9b`. Attendee code must not call a
