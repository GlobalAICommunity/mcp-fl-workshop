...
then returns parsed calls for `qwen3-vl-2b-instruct`; the host handles `final_answer`
...
The event image uses cached alias `qwen3-vl-2b-instruct`. Attendee code must not call a
