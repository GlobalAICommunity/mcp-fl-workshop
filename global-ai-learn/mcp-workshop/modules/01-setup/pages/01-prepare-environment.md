...
FastMCP 4.0.0, Foundry Local SDK 2.0.1, and the cached CPU variant
of model alias `qwen2.5-1.5b`.
...
one tool-selection completion. It can take several minutes. While `python.exe` is using
